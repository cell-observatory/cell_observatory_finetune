...
from segmentation.layers.layers import MLP
...
class TransformerDecoder(nn.Module):
    def __init__(self, 
        ...
        # 5. query perturbation module (perturbs query positions per decoder layer)
        # 6. reference anchor head (maps initial query pos. to latent space)
        # 7. query position sine scale (modulates sine positional encodings per query)
        ...
        self.pos_embedding = PositionEmbeddingSine(embed_dim // 3, normalize=True)   
